									...
									<div class="col">
										<div class="kanan col-sm-12 col-lg-12 mb-3">
											<div class="wrap table-responsive p-3 mt-3 mx-3 " style="background: #ffffff;	box-shadow: rgba(0, 0, 0, 0.18) 0px 2px 4px; border-radius: 5px 5px 5px 5px;">
												<h4 class="mb-4 fw-bolder " style="text-align:center ;">Hitung Data</h4>
									...
									<div class="col">
										<div class="wrap table-responsive p-3 mt-3 mx-3" style="background: #ffffff;	box-shadow: rgba(0, 0, 0, 0.18) 0px 2px 4px; border-radius: 5px 5px 5px 5px;">
											<h4 class="mb-4 fw-bolder " style="text-align:center ;">
												Hasil Data K= <?php echo $_POST['K'] ?></h4>
												...
												<tbody>
													...
													foreach ($k as $batasK) { ?>
														<tr>
															...
															<td <?php echo ($batasK['kategori'] == "Baik") ? "style='background-color: #ADFFA7; color: #20982C;'" : "style='background-color: #FFAEAE; color: #B53030'" ?>> <?php echo $batasK['kategori'] ?></td>
														</tr>
											...
											<table class="table table-hover table-bordered responsive-utilities text-center">
												...
												<tbody>
													<tr>
														...
														<td <?php echo ($kategori_kategori == "Baik") ? "style='background-color: #ADFFA7; color: #20982C;'" : "style='background-color: #FFAEAE; color: #B53030'" ?>><?php echo $kategori_kategori ?></td>
													</tr>
												</tbody>
											</table>
										</div>
